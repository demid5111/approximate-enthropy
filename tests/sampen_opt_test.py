...
class TestSampEnCalculateOverallSampEn(unittest.TestCase):
    ...
    def test_calculate_sampen_0_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', '0.txt'),
    ...
    def test_calculate_sampen_1_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', '1.txt'),
                                                 CalculationType.CONST, 0.5, False, 0)
    ...
    def test_calculate_sampen_2_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', '2.txt'),
                                                 CalculationType.CONST, 0.5, False, 0)
    ...
    def test_calculate_sampen_3_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', '3.txt'),
                                                 CalculationType.CONST, 0.5, False, 0)
    ...
    def test_calculate_sampen_4_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', '4.txt'),
                                                 CalculationType.CONST, 0.5, False, 0)
    ...
    def test_calculate_sampen_apsamp_const(self):
        r = self.apEn.prepare_calculate_windowed(2, os.path.join(constants.DATA_DIR, 'samp_en', 'ApEn_SampEn.txt'),
                                                 CalculationType.CONST, 0.5, False, 0)
